...
class FastaSeqGetter(object):
    ...
    def __init__(
        ...
        self.location: str = f"--location={output_dir}/tmp/"
        ...
        self.downloaded_files_path: str = f"{output_dir}/tmp/viral_sequences/sequences/fasta/"
        self.seq_files_location = f"{output_dir}/raw/"
...
class Covid19Genome(object):
    ...
    def __init__(
        self,
        output_dir: str = f"{__ORIG_WD__}/data/covid19_genome/",
    ):
        """
        ...
        self.raw_data_path = f"{self.data_path}/raw/"
        ...
        self.seq_getter = FastaSeqGetter(self.data_path)
    ...
    def getLocalAccessionsPath(self, lineage):
        local_accessions_set = self.getLocalAccessions(lineage)
        if lineage in self.local_lin_accs_dict:
            return [self.raw_data_path + acc + ".fasta" for acc in self.local_lin_accs_dict[lineage]]
        return []
    ...
    def _configureAccessionsFile(self):
        self.accessions_file = f"{__ORIG_WD__}/accessions.tsv"
